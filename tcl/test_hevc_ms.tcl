...
set src_dir "./src/hevc"
	...
	#top
	add_files -norecurse $src_dir/top_ms.sv
...
add_files -fileset sim_1 -norecurse "$tb_dir/tb_hevc_ms_2f.sv $tb_dir/input_16x16.mem $tb_dir/output_16x16_v2_h2.mem"
